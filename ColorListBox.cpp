...
// Use ClassWizard to add a member variable of type CColorListBox for the list box 
// you just added. If CColorListBox is not in the Variable Type list, choose CListBox, 
